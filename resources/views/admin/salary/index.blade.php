                        ...
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="card-header border-bottom d-flex justify-content-between">
                                    <h3 class="card-title">All Salary Info</h3>
                                ...
                                <div class="table-responsive">
                                    <table id="project-table" class="table text-nowrap mb-0 table-bordered border-top border-bottom project-list-main">
                                        ...
                                        <tr>
                                            ...
                                            <th class="bg-transparent border-bottom-0">Salary Amount</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h6 class="mb-0 fs-14 fw-semibold">{{$salary->employee->email}}</h6>
                                            </td>
                                            <td>
